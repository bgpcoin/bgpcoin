...
// https://github.com/transmission/miniupnpc/blob/e37cde82e8673a5e71bae43086828704fd5eeac1/miniupnpc.c#L283
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BGPCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"bgpcoin.com", "node.bgpcoin.com"},
    {"bgpcoin.com", "node2.bgpcoin.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("bgpcoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BGPCoin is probably already running."), addrBind.ToString().c_str());
        else
